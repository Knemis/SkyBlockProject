...
@NoArgsConstructor
public class MissionsCommand<T extends com.knemis.skyblock.skyblockcoreproject.teams.database.Team, U extends com.knemis.skyblock.skyblockcoreproject.teams.database.SkyBlockProjectUser<T>> extends Command<T, U> { // TODO: Update Team and SkyBlockProjectUser to actual classes
    ...
    public boolean execute(U user, T team, String[] args, SkyBlockProjectTeams<T, U> SkyBlockProjectTeams) {
        ...
        // MissionTypeSelectorInventoryConfig missionTypeSelectorInventoryConfig = SkyBlockProjectTeams.getInventories().missionTypeSelectorGUI; // TODO: Uncomment when Inventories config is refactored
            ...
            // switch (args[0].toLowerCase()) {
                // case "daily":
                    // if (missionTypeSelectorInventoryConfig.daily.enabled) {
                        // player.openInventory(new MissionGUI<>(team, MissionType.DAILY, player, SkyBlockProjectTeams).getInventory()); // TODO: Uncomment when MissionGUI and MissionType are refactored
                    // } else {
                        // player.openInventory(new MissionTypeSelectorGUI<>(player, SkyBlockProjectTeams).getInventory()); // TODO: Uncomment when MissionTypeSelectorGUI is refactored
                    // }
                    // return true;
                // case "weekly":
                    // if (missionTypeSelectorInventoryConfig.weekly.enabled) {
                        // player.openInventory(new MissionGUI<>(team, MissionType.WEEKLY, player, SkyBlockProjectTeams).getInventory()); // TODO: Uncomment when MissionGUI and MissionType are refactored
                    // } else {
                        // player.openInventory(new MissionTypeSelectorGUI<>(player, SkyBlockProjectTeams).getInventory()); // TODO: Uncomment when MissionTypeSelectorGUI is refactored
                    // }
                    // return true;
                // case "infinite":
                    // if (missionTypeSelectorInventoryConfig.infinite.enabled) {
                        // player.openInventory(new MissionGUI<>(team, MissionType.INFINITE, player, SkyBlockProjectTeams).getInventory()); // TODO: Uncomment when MissionGUI and MissionType are refactored
                    // } else {
                        // player.openInventory(new MissionTypeSelectorGUI<>(player, SkyBlockProjectTeams).getInventory()); // TODO: Uncomment when MissionTypeSelectorGUI is refactored
                    // }
                    // return true;
                // case "once":
                    // if (missionTypeSelectorInventoryConfig.once.enabled) {
                        // player.openInventory(new MissionGUI<>(team, MissionType.ONCE, player, SkyBlockProjectTeams).getInventory()); // TODO: Uncomment when MissionGUI and MissionType are refactored
                    // } else {
                        // player.openInventory(new MissionTypeSelectorGUI<>(player, SkyBlockProjectTeams).getInventory()); // TODO: Uncomment when MissionTypeSelectorGUI is refactored
                    // }
                    // return true;
