...
public class UpgradesGUI<T extends com.knemis.skyblock.skyblockcoreproject.teams.database.Team, U extends com.knemis.skyblock.skyblockcoreproject.teams.database.SkyBlockProjectUser<T>> /* extends com.knemis.skyblock.skyblockcoreproject.core.keviincore.gui.BackGUI */ { // TODO: Update Team and SkyBlockProjectUser to actual classes, resolve BackGUI
    ...
    public UpgradesGUI(T team, Player player, SkyBlockProjectTeams<T, U> SkyBlockProjectTeams) {
        // super(SkyBlockProjectTeams.getInventories().upgradesGUI.background, player, SkyBlockProjectTeams.getInventories().backButton); // TODO: Uncomment when BackGUI and inventories are refactored
    ...
    public Inventory getInventory() { // TODO: This method likely needs to be @Override if BackGUI is a proper GUI base class
        NoItemGUI noItemGUI = SkyBlockProjectTeams.getInventories().upgradesGUI;
    ...
    public void addContent(Inventory inventory) {
        ...
        upgrades.clear();
        // for (Map.Entry<String, com.knemis.skyblock.skyblockcoreproject.teams.enhancements.Enhancement<?>> enhancementEntry : SkyBlockProjectTeams.getEnhancementList().entrySet()) { // TODO: Uncomment when getEnhancementList and Enhancement are available
            ...
            // com.knemis.skyblock.skyblockcoreproject.teams.database.TeamEnhancement teamEnhancement = SkyBlockProjectTeams.getTeamManager().getTeamEnhancement(team, enhancementEntry.getKey()); // TODO: Uncomment when TeamManager and TeamEnhancement are refactored
            ...
            // String nextLevel = nextData == null ? SkyBlockProjectTeams.getMessages().nullPlaceholder : String.valueOf(teamEnhancement.getLevel() + 1);
            // String cost = nextData == null ? SkyBlockProjectTeams.getMessages().nullPlaceholder : String.valueOf(nextData.money);
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        // SkyBlockProjectTeams.getCommandManager().executeCommand(event.getWhoClicked(), SkyBlockProjectTeams.getCommands().upgradesCommand, new String[]{"buy", upgrade}); // TODO: Uncomment when CommandManager and Commands are refactored
    }

    public String formatPrice(double value) {
        // if (SkyBlockProjectTeams.getShop().abbreviatePrices) { // TODO: Uncomment when getShop is available
            // return SkyBlockProjectTeams.getConfiguration().numberFormatter.format(value); // TODO: Uncomment when Configuration and NumberFormatter are refactored
        // }
