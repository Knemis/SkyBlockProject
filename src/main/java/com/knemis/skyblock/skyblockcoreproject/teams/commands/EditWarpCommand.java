...
@NoArgsConstructor
public class EditWarpCommand<T extends com.knemis.skyblock.skyblockcoreproject.teams.database.Team, U extends com.knemis.skyblock.skyblockcoreproject.teams.database.IridiumUser<T>> extends Command<T, U> { // TODO: Update Team and IridiumUser to actual classes
    ...
    public boolean execute(U user, T team, String[] args, IridiumTeams<T, U> iridiumTeams) {
        ...
        // if (!iridiumTeams.getTeamManager().getTeamPermission(team, user, PermissionType.MANAGE_WARPS)) { // TODO: Uncomment when TeamManager is refactored
            ...
            // return false;
        // }
        // Optional<com.knemis.skyblock.skyblockcoreproject.teams.database.TeamWarp> teamWarp = iridiumTeams.getTeamManager().getTeamWarp(team, args[0]); // TODO: Uncomment when TeamManager and TeamWarp are refactored
        ...
        // switch (args[1]) { // TODO: Uncomment when teamWarp is available
            // case "icon":
                ...
                // if (!xMaterial.isPresent()) {
                    // player.sendMessage(StringUtils.color(iridiumTeams.getMessages().noSuchMaterial // TODO: Replace StringUtils.color
                            // .replace("%prefix%", iridiumTeams.getConfiguration().prefix)
                    // ));
                    // return false;
                // }
                // teamWarp.get().setIcon(xMaterial.get());
                // player.sendMessage(StringUtils.color(iridiumTeams.getMessages().warpIconSet // TODO: Replace StringUtils.color
                        // .replace("%prefix%", iridiumTeams.getConfiguration().prefix)
                // ));
                // return true;
            // case "description":
                ...
                // player.sendMessage(StringUtils.color(iridiumTeams.getMessages().warpDescriptionSet // TODO: Replace StringUtils.color
                        // .replace("%prefix%", iridiumTeams.getConfiguration().prefix)
                // ));
                // return true;
            // default:
