...
public class BlockValueGUI<T extends com.knemis.skyblock.skyblockcoreproject.teams.database.Team, U extends com.knemis.skyblock.skyblockcoreproject.teams.database.IridiumUser<T>> /* extends com.keviin.keviincore.gui.PagedGUI<BlockValues.ValuableBlock> */ { // TODO: Update Team and IridiumUser to actual classes, resolve PagedGUI
    ...
    public void addContent(Inventory inventory) {
        ...
        // for (Map.Entry<XMaterial, BlockValues.ValuableBlock> entry : iridiumTeams.getBlockValues().blockValues.entrySet().stream().filter(entry -> entry.getValue().page == getPage()).collect(Collectors.toList())) { // TODO: Uncomment when getBlockValues and getPage are available
    ...
    public Collection<BlockValues.ValuableBlock> getPageObjects() {
        // return iridiumTeams.getBlockValues().blockValues.values(); // TODO: Uncomment when getBlockValues is available
    ...
    public int getSize(){
        ...
        return iridiumTeams.getInventories().blockValueGUI.size;
    }
}
