...
@NoArgsConstructor
public class TrustsCommand<T extends Team, U extends User<T>> extends Command<T, U> {
    ...
    public boolean execute(U user, T team, String[] arguments, SkyBlockTeams<T, U> skyblockTeams) {
        ...
        player.openInventory(new TrustsGUI<>(team, player, skyblockTeams).getInventory());
        return true;
    }
