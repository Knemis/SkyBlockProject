...
public class UpgradesGUI<T extends com.knemis.skyblock.skyblockcoreproject.teams.database.Team, U extends com.knemis.skyblock.skyblockcoreproject.teams.database.User<T>> /* extends com.keviin.keviincore.gui.BackGUI */ {
    ...
    public UpgradesGUI(T team, Player player, SkyBlockTeams<T, U> skyblockTeams) {
        // super(skyblockTeams.getInventories().upgradesGUI.background, player, skyblockTeams.getInventories().backButton); // TODO: Uncomment when BackGUI and inventories are refactored
    ...
    public Inventory getInventory() { // TODO: This method likely needs to be @Override if BackGUI is a proper GUI base class
        NoItemGUI noItemGUI = skyblockTeams.getInventories().upgradesGUI;
    ...
    public void addContent(Inventory inventory) {
        ...
        upgrades.clear();
        // for (Map.Entry<String, com.knemis.skyblock.skyblockcoreproject.teams.enhancements.Enhancement<?>> enhancementEntry : skyblockTeams.getEnhancementList().entrySet()) { // TODO: Uncomment when getEnhancementList and Enhancement are available
            ...
            // com.knemis.skyblock.skyblockcoreproject.teams.database.TeamEnhancement teamEnhancement = skyblockTeams.getTeamManager().getTeamEnhancement(team, enhancementEntry.getKey()); // TODO: Uncomment when TeamManager and TeamEnhancement are refactored
            ...
            // String nextLevel = nextData == null ? skyblockTeams.getMessages().nullPlaceholder : String.valueOf(teamEnhancement.getLevel() + 1);
            // String cost = nextData == null ? skyblockTeams.getMessages().nullPlaceholder : String.valueOf(nextData.money);
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        // skyblockTeams.getCommandManager().executeCommand(event.getWhoClicked(), skyblockTeams.getCommands().upgradesCommand, new String[]{"buy", upgrade}); // TODO: Uncomment when CommandManager and Commands are refactored
    }
