...
@NoArgsConstructor
public class InvitesCommand<T extends com.knemis.skyblock.skyblockcoreproject.teams.database.Team, U extends com.knemis.skyblock.skyblockcoreproject.teams.database.SkyBlockProjectUser<T>> extends Command<T, U> { // TODO: Update Team and SkyBlockProjectUser to actual classes
    ...
    public boolean execute(U user, T team, String[] arguments, SkyBlockProjectTeams<T, U> SkyBlockProjectTeams) {
        ...
        // player.openInventory(new InvitesGUI<>(team, player, SkyBlockProjectTeams).getInventory()); // TODO: Uncomment when InvitesGUI is refactored
