...
@Getter
@NoArgsConstructor
public abstract class SkyBlockProjectTeams<T extends Team, U extends SkyBlockProjectUser<T>> {
    ...
    public abstract com.knemis.skyblock.skyblockcoreproject.teams.managers.SkyBlockProjectUserManager<T, U> getUserManager();
