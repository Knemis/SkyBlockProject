...
public class ShopOverviewGUI<T extends com.knemis.skyblock.skyblockcoreproject.teams.database.Team, U extends com.knemis.skyblock.skyblockcoreproject.teams.database.SkyBlockProjectUser<T>> /* extends com.knemis.skyblock.skyblockcoreproject.core.keviincore.gui.BackGUI */ { // TODO: Update Team and SkyBlockProjectUser to actual classes, resolve BackGUI
    ...
    public ShopOverviewGUI(Player player, SkyBlockProjectTeams<T, U> SkyBlockProjectTeams) {
        // super(SkyBlockProjectTeams.getInventories().shopOverviewGUI.background, player, SkyBlockProjectTeams.getInventories().backButton); // TODO: Uncomment when BackGUI and inventories are refactored
    ...
    public void addContent(Inventory inventory) {
        ...
        // for (Shop.ShopCategory category : SkyBlockProjectTeams.getShop().categories.values()) { // TODO: Uncomment when getShop is available
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        // for (Map.Entry<String, Shop.ShopCategory> category : SkyBlockProjectTeams.getShop().categories.entrySet()) { // TODO: Uncomment when getShop is available
            // if (event.getSlot() != category.getValue().item.slot) continue;
            // event.getWhoClicked().openInventory(new ShopCategoryGUI<>(category.getKey(), (Player) event.getWhoClicked(), 1, SkyBlockProjectTeams).getInventory()); // TODO: Uncomment when ShopCategoryGUI is refactored
            // return;
        // }
