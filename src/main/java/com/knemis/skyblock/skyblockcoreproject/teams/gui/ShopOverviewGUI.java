...
public class ShopOverviewGUI<T extends com.knemis.skyblock.skyblockcoreproject.teams.database.Team, U extends com.knemis.skyblock.skyblockcoreproject.teams.database.User<T>> /* extends com.keviin.keviincore.gui.BackGUI */ {
    private final SkyBlockTeams<T, U> skyblockTeams;
    private Player player; // Added player field

    public ShopOverviewGUI(Player player, SkyBlockTeams<T, U> skyblockTeams) {
        // super(skyblockTeams.getInventories().shopOverviewGUI.background, player, skyblockTeams.getInventories().backButton); // TODO: Uncomment when BackGUI and inventories are refactored
    ...
    public void addContent(Inventory inventory) {
        ...
        // for (Shop.ShopCategory category : skyblockTeams.getShop().categories.values()) { // TODO: Uncomment when getShop is available
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        // for (Map.Entry<String, Shop.ShopCategory> category : skyblockTeams.getShop().categories.entrySet()) { // TODO: Uncomment when getShop is available
            // if (event.getSlot() != category.getValue().item.slot) continue;
            // event.getWhoClicked().openInventory(new ShopCategoryGUI<>(category.getKey(), (Player) event.getWhoClicked(), 1, skyblockTeams).getInventory()); // TODO: Uncomment when ShopCategoryGUI is refactored
            // return;
        // }
