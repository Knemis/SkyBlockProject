...
@NoArgsConstructor
public class PromoteCommand<T extends com.knemis.skyblock.skyblockcoreproject.teams.database.Team, U extends com.knemis.skyblock.skyblockcoreproject.teams.database.SkyBlockProjectUser<T>> extends Command<T, U> { // TODO: Update Team and SkyBlockProjectUser to actual classes
    ...
    public boolean execute(U user, T team, String[] args, SkyBlockProjectTeams<T, U> SkyBlockProjectTeams) {
        ...
        // U targetUser = SkyBlockProjectTeams.getUserManager().getUser(targetPlayer); // TODO: Uncomment when UserManager is refactored

        // if (targetUser.getTeamID() != team.getId()) { // TODO: Uncomment when targetUser and Team are refactored
            // player.sendMessage(StringUtils.color(SkyBlockProjectTeams.getMessages().userNotInYourTeam.replace("%prefix%", SkyBlockProjectTeams.getConfiguration().prefix))); // TODO: Replace StringUtils.color
            // return false;
        // }

        // int nextRank = targetUser.getUserRank() + 1; // TODO: Uncomment when targetUser is refactored

        // if (!DoesRankExist(nextRank, SkyBlockProjectTeams) || IsHigherRank(targetUser, user) || !SkyBlockProjectTeams.getTeamManager().getTeamPermission(team, user, PermissionType.PROMOTE)) { // TODO: Uncomment when dependencies are refactored
            // player.sendMessage(StringUtils.color(SkyBlockProjectTeams.getMessages().cannotPromoteUser.replace("%prefix%", SkyBlockProjectTeams.getConfiguration().prefix))); // TODO: Replace StringUtils.color
            // return false;
        // }
        ...
        // for (U member : SkyBlockProjectTeams.getTeamManager().getTeamMembers(team)) { // TODO: Uncomment when TeamManager is refactored
            ...
            // if (teamMember != null) {
                // if (teamMember.equals(player)) {
                    // teamMember.sendMessage(StringUtils.color(SkyBlockProjectTeams.getMessages().promotedPlayer // TODO: Replace StringUtils.color
                            // .replace("%player%", targetUser.getName())
                            // .replace("%rank%", SkyBlockProjectTeams.getUserRanks().get(nextRank).name) // TODO: Uncomment when getUserRanks is available
                            // .replace("%prefix%", SkyBlockProjectTeams.getConfiguration().prefix)
                    // ));
                // } else {
                    // teamMember.sendMessage(StringUtils.color(SkyBlockProjectTeams.getMessages().userPromotedPlayer // TODO: Replace StringUtils.color
    ...
    private boolean DoesRankExist(int rank, SkyBlockProjectTeams<T, U> SkyBlockProjectTeams) {
        ...
        // return SkyBlockProjectTeams.getUserRanks().containsKey(rank); // TODO: Uncomment when getUserRanks is available
