...
public class MissionTypeSelectorGUI<T extends com.knemis.skyblock.skyblockcoreproject.teams.database.Team, U extends com.knemis.skyblock.skyblockcoreproject.teams.database.User<T>> /* extends com.keviin.keviincore.gui.BackGUI */ {

    private final SkyBlockTeams<T, U> skyblockTeams;
    private Player player; // Added player field

    public MissionTypeSelectorGUI(Player player, SkyBlockTeams<T, U> skyblockTeams) {
        // super(skyblockTeams.getInventories().missionTypeSelectorGUI.background, player, skyblockTeams.getInventories().backButton); // TODO: Uncomment when BackGUI and inventories are refactored
    ...
    public Inventory getInventory() { // TODO: This method likely needs to be @Override if BackGUI is a proper GUI base class
        NoItemGUI noItemGUI = skyblockTeams.getInventories().missionTypeSelectorGUI;
    ...
    public void addContent(Inventory inventory) {
        ...
        MissionTypeSelectorInventoryConfig missionTypeSelectorInventoryConfig = skyblockTeams.getInventories().missionTypeSelectorGUI;
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        // if (event.getSlot() == missionTypeSelectorInventoryConfig.daily.item.slot && missionTypeSelectorInventoryConfig.daily.enabled) { // TODO: Uncomment when missionTypeSelectorInventoryConfig is available
            // skyblockTeams.getCommandManager().executeCommand(event.getWhoClicked(), skyblockTeams.getCommands().missionsCommand, new String[]{"Daily"}); // TODO: Uncomment when CommandManager and Commands are refactored
        // }
        ...
        // if (event.getSlot() == missionTypeSelectorInventoryConfig.weekly.item.slot && missionTypeSelectorInventoryConfig.weekly.enabled) { // TODO: Uncomment when missionTypeSelectorInventoryConfig is available
            // skyblockTeams.getCommandManager().executeCommand(event.getWhoClicked(), skyblockTeams.getCommands().missionsCommand, new String[]{"Weekly"}); // TODO: Uncomment when CommandManager and Commands are refactored
        // }
        ...
        // if (event.getSlot() == missionTypeSelectorInventoryConfig.infinite.item.slot && missionTypeSelectorInventoryConfig.infinite.enabled) { // TODO: Uncomment when missionTypeSelectorInventoryConfig is available
            // skyblockTeams.getCommandManager().executeCommand(event.getWhoClicked(), skyblockTeams.getCommands().missionsCommand, new String[]{"Infinite"}); // TODO: Uncomment when CommandManager and Commands are refactored
        // }
        ...
        // if (event.getSlot() == missionTypeSelectorInventoryConfig.once.item.slot && missionTypeSelectorInventoryConfig.once.enabled) { // TODO: Uncomment when missionTypeSelectorInventoryConfig is available
            // skyblockTeams.getCommandManager().executeCommand(event.getWhoClicked(), skyblockTeams.getCommands().missionsCommand, new String[]{"Once"}); // TODO: Uncomment when CommandManager and Commands are refactored
        // }
    }
}
