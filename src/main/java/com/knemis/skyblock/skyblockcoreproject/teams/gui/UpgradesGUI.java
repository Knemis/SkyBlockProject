...
public class UpgradesGUI<T extends Team, U extends SkyBlockProjectTeamsUser<T>> extends BackGUI {
    ...
    public UpgradesGUI(T team, Player player, SkyBlockProjectTeams<T, U> SkyBlockProjectTeams) {
        super(SkyBlockProjectTeams.getInventories().upgradesGUI.background, player, SkyBlockProjectTeams.getInventories().backButton);
        this.team = team;
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        SkyBlockProjectTeams.getCommandManager().executeCommand(event.getWhoClicked(), SkyBlockProjectTeams.getCommands().upgradesCommand, new String[]{"buy", upgrade});
    }
