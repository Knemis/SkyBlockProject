...
@NoArgsConstructor
public class LevelCommand<T extends com.knemis.skyblock.skyblockcoreproject.teams.database.Team, U extends com.knemis.skyblock.skyblockcoreproject.teams.database.SkyBlockProjectUser<T>> extends Command<T, U> { // TODO: Update Team and SkyBlockProjectUser to actual classes
    ...
    public boolean execute(U user, String[] args, SkyBlockProjectTeams<T, U> SkyBlockProjectTeams) {
        ...
        // if (args.length == 0) { // TODO: Uncomment when TeamManager is refactored
            ...
            // if (!userTeam.isPresent()) {
                ...
                // return false;
            // }
            // sendTeamLevel(player, userTeam.get(), SkyBlockProjectTeams);
            // return true;
        // }
        ...
        // sendTeamLevel(player, team.get(), SkyBlockProjectTeams); // TODO: Uncomment when team is available
        player.sendMessage("Level command needs to be reimplemented after refactoring."); // Placeholder
        return true;
    }

    public void sendTeamLevel(Player player, T team, SkyBlockProjectTeams<T, U> SkyBlockProjectTeams) {
        ...
        // for (String line : SkyBlockProjectTeams.getConfiguration().levelInfo) { // TODO: Uncomment when Configuration is refactored
